...
*${p+=1}.* ${prefix}сменитьаватаркугруппы _выбрать изображение_
...
*${p+=1}.* ${prefix}снятьадминку _@_
*${p+=1}.* ${prefix}удалить _@_
*${p+=1}.* ${prefix}добавить _номер без +_
*${p+=1}.* ${prefix}внимание
*${p+=1}.* ${prefix}сылкагруппы
*${p+=1}.* ${prefix}сброситьссылку
*${p+=1}.* ${prefix}антиссылка (удаляет только за ссылки группы ватсапп)
*${p+=1}.* ${prefix}антиссылка2 (удаляет за все ссылки)
...
*ПОИСКОВИКИ*
*${p+=1}.* ${prefix}плеймаркет _название приложения_
...
*НАДПИСИ С ФОНОМ*
*${p+=1}.* ${prefix}логотипволка _text1|text2_
